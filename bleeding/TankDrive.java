...
public final class TankDrive {
    public static class Params {
        ...
        public double trackWidthTicks = 38.6;
        ...
        public double turnVelGain = 1.0;
    }

    public static Params PARAMS = new Params();

    public final TankKinematics kinematics = new TankKinematics(Math.max(PARAMS.inPerTick * PARAMS.trackWidthTicks, 0.001));
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, HardwareNames.LEFT_MOTOR));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, HardwareNames.RIGHT_MOTOR));
        ...
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
        lazyImu = new LazyHardwareMapImu(hardwareMap, HardwareNames.IMU, new RevHubOrientationOnRobot(PARAMS.logoFacingDirection, PARAMS.usbFacingDirection));
